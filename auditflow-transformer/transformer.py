...
# Sources, lowest precedence first: shipped 'transformers/', pip-installed wheels
# advertising the 'auditflow.transformers' entry-point group, then anything mounted in
# 'transformers_bootstrap/'.
registry = PluginRegistry(
    base_dir=current_dir,
    dir_specs=[("transformers", "internal"), ("transformers_bootstrap", "external")],
    entry_point="transform",
    entry_point_group="auditflow.transformers",
).discover()
