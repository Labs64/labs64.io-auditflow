...
Drop `mytransformer.py` into `transformers/` (or `transformers_bootstrap/` at runtime) implementing
`transform(input_data: dict) -> dict` — see [DEVELOPERS.md](../DEVELOPERS.md#adding-a-new-transformer)
